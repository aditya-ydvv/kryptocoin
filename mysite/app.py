...
#configure mysql
app.config['MYSQL_HOST'] = 'kryptocoin.mysql.pythonanywhere-services.com'
app.config['MYSQL_USER'] = 'kryptocoin'
app.config['MYSQL_PASSWORD'] = 'adityaa123'
app.config['MYSQL_DB'] = 'kryptocoin$default'
